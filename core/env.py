...
DEFAULT_INTERNET_CHECKPOINT = "https://quad9.net"

DEFAULT_SERVICE_REST = 30
DEFAULT_EPOCH = 3600 * 24 * 7
DEFAULT_MILESTONE = DEFAULT_EPOCH * 4
...
INTERNET_CHECKPOINT = network.get('checkpoin', DEFAULT_INTERNET_CHECKPOINT)
